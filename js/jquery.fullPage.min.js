...
transition:b})}function Ya(a,b){if(825>a||900>b){var c=p.min(100*a/825,100*b/900).toFixed(2);q.css("fonts-size",c+"%")}else q.css("fonts-size","100%")}function W(a,b){c.menu&&(d(c.menu).find(".active").removeClass("active"),d(c.menu).find('[data-menuanchor="'+a+'"]').addClass("active"));c.navigation&&(d("#fp-nav").find(".active").removeClass("active"),a?d("#fp-nav").find('a[href="#'+a+'"]').addClass("active"):d("#fp-nav").find("li").eq(b).find("a").addClass("active"))}function Y(a){var b=d(".fp-section.active").index(".fp-section");
